...
A hands-on companion repository for learning language modelling concepts, applied to **petrophysical well log interpretation**. Each module pairs a core NLP/ML concept with a practical well log use case.
